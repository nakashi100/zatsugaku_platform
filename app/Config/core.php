...
// Configure::write('debug', 2);
	// Configure::write('debug', 0); // 本番環境？
   Configure::write('debug', 1); // 開発環境
 ...
 */
	Configure::write('Security.salt', '21ab35ac8225559fb46ffa2d22697a6084b72742');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '284337534322771880184340929421');
